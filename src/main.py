...
class Main(Node2D):
    ...
    def _start(self) -> None:
        ...
        bg_color_rect.size = Size2D(level_state.boundary.w, bg_color_rect.size.h)
        bridge_ground: Sprite = self.get_child("BridgeGround")
        bridge_ground_draw_source = bridge_ground.draw_source
        bridge_ground_draw_source.w = level_state.boundary.w
        ...
        buildings_draw_source.w = level_state.boundary.w
